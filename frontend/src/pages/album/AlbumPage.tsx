			...
			<ScrollArea className='h-full rounded-md'>
					...
					<div className='relative z-10'>
						<div className='flex flex-col sm:flex-row p-4 sm:p-6 gap-4 sm:gap-6 pb-6 sm:pb-8'>
							<img
								...
								className='w-48 h-48 sm:w-[200px] sm:h-[200px] lg:w-[240px] lg:h-[240px] shadow-xl rounded mx-auto sm:mx-0'
							/>
							<div className='flex flex-col justify-end text-center sm:text-left'>
								<p className='text-sm font-medium'>Album</p>
								<h1 className='text-3xl sm:text-5xl lg:text-7xl font-bold my-2 sm:my-4'>{currentAlbum?.title}</h1>
						...
						{/* play button */}
						<div className='px-4 sm:px-6 pb-4 flex items-center justify-center sm:justify-start gap-4 sm:gap-6'>
							<Button
                ...
                hover:scale-105 transition-all'
						...
						<div className='bg-black/20 backdrop-blur-sm'>
							{/* table header */}
							<div
								className='grid grid-cols-[16px_4fr_2fr_1fr] gap-2 sm:gap-4 px-4 sm:px-10 py-2 text-xs sm:text-sm 
            text-zinc-400 border-b border-white/5'
									...
									{currentAlbum?.songs.map((song, index) => {
										...
										return (
											<div
												...
												className={`grid grid-cols-[16px_4fr_2fr_1fr] gap-2 sm:gap-4 px-2 sm:px-4 py-2 text-xs sm:text-sm 
                      ...
                      `}
											>
												...
												<div className='flex items-center hidden sm:block text-xs sm:text-sm'>{song.createdAt.split("T")[0]}</div>
